...
const NavbarHomepage = () => {
  ...
  return (
    <div className="font-poppins bg-white border-t-[8px] border-t-forestgreen-300 border-b-2 border-b-forestgreen-300 text-xl antialiased fixed w-screen h-28 flex justify-between items-center px-10 lg:px-16 py-4 top-0 left-0 z-50">
