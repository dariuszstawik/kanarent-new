...
const CategoryCard = ({ title, img, href }) => {
  return (
    <Link href={`../${href}`}>
      <div
        className={`w-[300px] flex flex-col items-start justify-start text-center text-5xl text-white font-poppins}`}
      >
        ...
        <button className="cursor-pointer py-3 px-[78px] bg-[transparent] rounded-t-none rounded-b-11xl flex flex-row items-start justify-start gap-[5px] z-[2] border-[2px] border-solid border-forestgreen-300 mq450:pl-5 mq450:pr-5 mq450:box-border">
          ...
          <div className="relative text-base leading-[30px] font-semibold font-poppins text-forestgreen-300 text-center inline-block min-w-[123px] z-[3]">
            Wyświetl sprzęt
          </div>
